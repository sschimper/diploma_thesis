...
\begin{figure} 
	...
	\caption{Selection of calculated intersection points between a ray and two spheres according to the Boolean set operations. The horizontal line illustrates the ray, and the red circles depict the intersection points. The outlines of the two spheres depict a cross-section of the 3D objects.}
	\label{fig:csg_rc}
\end{figure}
