...
\def\ThesisTitle{Integration of Intel\textregistered's ray tracing framework Embree into the ART rendering system}
...
\def\Keywords{%
\xxx{{ray-tracing} {Embree} {acceleration} {}}
}
