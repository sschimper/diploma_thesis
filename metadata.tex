...
\def\ThesisTitle{Implementation of CSG Operations Using a Modern High Performance Ray Casting Library}
...
\def\Dedication{%
I owe a significant depth of gratitude to my supervisor, doc. Alexander Wilkie Dr., for the possibility to contribute to the development of a groundbreaking rendering system, and for his help and support. I would also like to express sincere thankfulness towards Alban Fichet, whose help and feedback was of crucial importance to my work, as well as towards various members of the Computer Graphics Group in Prague for numerous reviews and discussions. Additionally, I would like to thank the "Computer Graphics Stack Exchange" users Peter and Simon F, two strangers on the internet, for offering help when no help was available and thus preventing me from going completely nuts. 
Finally, I would like to thank my family and friends and Monika for their love and support during difficult times.
}
...
\def\Keywords{{ray tracing,} {acceleration data structures,} {Embree,} {constructive solid geometry}}
